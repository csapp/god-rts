...
--particleOne
local particleOneGravity = 25 -- how fast does it fall?
...
local particleOneTexture = 'LuaRules/Gadgets/snowflake.tga'  -- what bitmap are we using?
local particleOneScale = 6000  -- scale, see GLSL for details

local particleTwoGravity = 20 -- how fast does it fall?
...
local particleTwoTexture = 'LuaRules/Gadgets/snowflake.tga'   -- what bitmap are we using?
local particleTwoScale = 6000  -- scale, see GLSL for details

local particleThreeGravity = 30 -- how fast does it fall?
...
local particleThreeTexture = 'LuaRules/Gadgets/snowflake.tga'  -- what bitmap are we using?
